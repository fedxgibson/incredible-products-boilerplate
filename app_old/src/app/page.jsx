    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center">
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
          Unlock the power of conversational AI with Claude. Smarter, faster,
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
            ...
            <p className="text-gray-600">
              Powered by state-of-the-art language models for human-like
      ...
      <footer className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center text-gray-600">
        <p>© 2025 Claude AI. All rights reserved.</p>
      </footer>
    </div>
  );
}
